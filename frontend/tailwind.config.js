...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Semantic tokens — all driven by CSS variables so light/dark is one source of truth.
      ...
      boxShadow: {
        ...
        card: '0 1px 3px rgb(15 23 42 / 0.05), 0 8px 24px -8px rgb(15 23 42 / 0.08)',
        elevated: '0 4px 12px rgb(15 23 42 / 0.08), 0 16px 40px -12px rgb(15 23 42 / 0.16)',
        glow: '0 0 0 1px rgb(var(--primary) / 0.15), 0 8px 32px -8px rgb(var(--primary) / 0.35)',
      },
      keyframes: {
