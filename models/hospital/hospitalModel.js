...
const hospitalSchema = new Schema(
  {
    name: { type: String, required: [true, "Hospital/Center name is required"], trim: true },
    type: { type: String, enum: ["hospital", "clinic", "lab", "diagnostic_center"], required: true, default: "hospital" },
    address: { type: String, required: [true, "Address is required"], trim: true },
    contactNo: { type: String, required: [true, "Contact number is required"], match: [/^\+?[0-9]{10,15}$/, "Please enter a valid contact number (10-15 digits)."], unique: true },
    geoLocation: {
